...
using OrderApp.Business.Concrete;
using OrderApp.Business.Interfaces;
using OrderApp.DataAccess.Concrete.EFCore.Context;
using OrderApp.DataAccess.Concrete.EFCore.Repositories;
...
namespace OrderApp.WebApi
{
    public class Startup
    {
        ...
        options.UseSqlServer(Configuration.GetConnectionString("OrderAppConnection")));
